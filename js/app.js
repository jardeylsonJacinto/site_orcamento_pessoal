...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById('modal_conteudo').innerHTML = 'Erro na gravação! verefique se todos os campos estão preenchidos corretamente!';
